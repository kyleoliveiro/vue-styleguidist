...
export default function Usage(_ref) {
	...
	if (slots && Object.keys(slots).length > 0) {
		slotsNode = slots && React.createElement(SlotsTable, { props: slots });
	}
	var propsNode = props && React.createElement(Props, { props: props });
	var eventsNode = void 0;
	if (events && Object.keys(events).length > 0) {
		eventsNode = events && React.createElement(Events, { props: events });
	}
	var methodsNode =
		methods && methods.length > 0 && React.createElement(Methods, { methods: methods });
