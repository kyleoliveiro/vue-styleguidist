...
describe('Usage', function() {
	it('should render props table', function() {
		var actual = shallow(React.createElement(Usage, { props: { props: props } }));

		expect(actual).toMatchSnapshot();
	});

	it('should render methods table', function() {
		var actual = shallow(React.createElement(Usage, { props: { methods: methods } }));

		expect(actual).toMatchSnapshot();
	});

	it('should render nothing without props and methods', function() {
		var actual = shallow(React.createElement(Usage, { props: {} }));
